...
export default async function ModPage({
  ...
  if (error) {
    console.error("Gagal mengambil detail mod:", error);
    notFound();
  }
  ...
  return (
    <div className="container detail">
      <main className="detailMain">
        ...
        <span className="tag">
          {category?.game?.toUpperCase()} · {category?.name}
        </span>
